...
export const dictionary = {
  it: {
    ...
    checkout_brt_intro: 'Seleziona il tuo Fermopoint BRT vicino a te. Puoi cercarlo manualmente con il CAP oppure usare la posizione attuale.',
    checkout_brt_search_address: 'Cerca con il CAP',
    checkout_brt_use_location: 'Usa la mia posizione',
    checkout_brt_open_locator: 'Apri la mappa ufficiale BRT',
    checkout_brt_manual_entry: 'Inserisci manualmente il Fermopoint BRT scelto',
    checkout_brt_manual_fallback: 'Non trovi il tuo punto? Inseriscilo manualmente',
    checkout_brt_back_search: 'Torna alla ricerca Fermopoint',
    checkout_brt_distance: '{distance} km di distanza',
    checkout_brt_cap_error: 'Inserisci un CAP valido (5 cifre)',
    checkout_brt_none_found: 'Nessun Fermopoint BRT trovato per questa ricerca',
    checkout_brt_network_error: 'Errore di rete durante la ricerca dei Fermopoint BRT',
    checkout_brt_geolocation_unavailable: 'Geolocalizzazione non disponibile sul dispositivo',
    checkout_brt_geolocation_denied: 'Non e stato possibile usare la posizione attuale',
    checkout_brt_cod_disabled: 'Il contrassegno non e disponibile per il ritiro presso BRT Fermopoint.',
  ...
  en: {
    ...
    checkout_brt_intro: 'Choose the BRT Fermopoint closest to you. You can search manually by postal code or use your current location.',
    checkout_brt_search_address: 'Search by postal code',
    checkout_brt_use_location: 'Use my location',
    checkout_brt_open_locator: 'Open the official BRT map',
    checkout_brt_manual_entry: 'Enter the selected BRT Fermopoint manually',
    checkout_brt_manual_fallback: 'Cannot find your point? Enter it manually',
    checkout_brt_back_search: 'Back to Fermopoint search',
    checkout_brt_distance: '{distance} km away',
    checkout_brt_cap_error: 'Enter a valid postal code (5 digits)',
    checkout_brt_none_found: 'No BRT Fermopoint found for this search',
    checkout_brt_network_error: 'Network error while searching BRT Fermopoints',
    checkout_brt_geolocation_unavailable: 'Geolocation is not available on this device',
    checkout_brt_geolocation_denied: 'Current location could not be used',
    checkout_brt_cod_disabled: 'Cash on delivery is not available with BRT Fermopoint pickup.',
