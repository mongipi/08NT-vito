...
export const dictionary = {
  it: {
    ...
    checkout_islands_poste_only:
      'Per le isole è disponibile solo **Poste Italiane** come punto di ritiro.',
    ...
    checkout_brt_intro:
      'Seleziona il tuo Fermopoint BRT vicino a te. Puoi cercarlo manualmente con il CAP oppure usare la posizione attuale.',
    ...
    checkout_brt_cod_disabled:
      'Il contrassegno non e disponibile per il ritiro presso BRT Fermopoint.',
  ...
  en: {
    ...
    checkout_islands_poste_only:
      'For islands only **Poste Italiane** is available as a pickup point.',
    checkout_carrier: 'Carrier',
    checkout_carrier_brt: 'BRT Fermopoint',
    checkout_carrier_poste: 'Poste Italiane',
    checkout_find_nearest_point: 'Find the nearest point to you:',
    checkout_brt_intro:
      'Choose the BRT Fermopoint closest to you. You can search manually by postal code or use your current location.',
