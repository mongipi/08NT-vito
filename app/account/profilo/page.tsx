      ...
      <div style={{ maxWidth: '44rem', margin: '0 auto', padding: '1.75rem 1.25rem 3rem', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div style={card}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                ...
                <Field label="Codice fiscale" name="fiscalCode" defaultValue={user.fiscalCode} placeholder="RSSMRA80A01H501U" />
              </div>
              <div>
          ...
          <div style={card}>
            <p style={sec}>
              ...
              <span style={{ fontWeight: 300, textTransform: 'none', letterSpacing: 0 }}>
                (per fatturazione e acquisti B2B)
              </span>
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                ...
                <Field label="Codice SDI" name="sdiCode" defaultValue={user.sdiCode} placeholder="XXXXXXX" />
              </div>
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem' }}>
            <p style={{ ...sec, margin: 0, border: 'none', paddingBottom: 0 }}>Indirizzi di spedizione</p>
